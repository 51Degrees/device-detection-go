...
func main() {
	...
	fmt.Println("   IsMobile: ", manager.Process(mobileUserAgent).Get("IsMobile"))

	// Carries out a macth for a desktop User-Agent.
	fmt.Println("\nDesktop User-Agent: ", desktopUserAgent)
	fmt.Println("   IsMobile: ", manager.Process(desktopUserAgent).Get("IsMobile"))

	// Carries out a match for a MediaHub User-Agent.
	fmt.Println("\nMediaHub User-Agent: ", mediaHubUserAgent)
	fmt.Println("   IsMobile: ", manager.Process(mediaHubUserAgent).Get("IsMobile"))
}
